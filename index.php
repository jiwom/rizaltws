    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Select Services</a>
            </li>
                <li class="no-padding">
...
<div id="Services" class="tabcontent">
  <h3></h3>
  <center>
          <button class="button">Padala</button><br><br>
           <button class="button">Pabili</button><br><br>
            <button class="button">Pa-Grocery</button><br><br>
             <button class="button">Pabayad ng Bills</button>
        </center>
</div>
